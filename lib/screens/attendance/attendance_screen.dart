...
class _AttendanceScreenState extends State<AttendanceScreen>
  ...
  AttendanceRepository get _repository => widget.repository;
  ...
  Future<void> _loadPlayers() async {
    ...
    try {
      ...
      await _repository.getCoachPlayers();
  ...
  Future<void> _markAttendance(String status) async {
    final PlayerModel? player = _selectedPlayer;
    if (player == null) return;

    try {
      await _repository.markAttendance(
        //sessionId: 1, // Replace with actual sessionId from context/nav args
        playerId: player.id,
        status: status,
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: _AttendanceActionBar(
        player: _selectedPlayer,
        onPresent: () => _markAttendance('Present'),
        onExcused: () => _markAttendance('Excused'),
...
class _AttendancePlayerAvatar extends StatelessWidget {
  const _AttendancePlayerAvatar({
    required this.player,
    required this.isSelected,
  });
          ...
          child: Container(
            ...
            child: SafeArea(
              ...
              child: current == null
                ...
                children: <Widget>[
                  _AttendancePlayerAvatar(
                      player: current, isSelected: true),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 6),
            Text(
              'There are no players assigned to take attendance for.',
